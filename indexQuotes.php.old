	...
	<body onload='focus()'>
		...
		<div class='quickLinks'>
			<ul style='margin-top: 6px;'>
				...
				<li id='ProgrammingFolder' class='folderClosed'><a class='folder' onclick='manageFolder("Programming")'>Programming</a>
					<ul id='Programming'>
						<li class='link'><a href='http://localhost:8000/'>localhost:8000</a></li>
						<li class='link'><a href='https://github.com/'>GitHub</a></li>
						<li class='last link'><a href='https://laracasts.com/'>Laravel Course</a></li>
					</ul>
				</li>
				...
				<li class='last link'><a href='https://play.pokemonshowdown.com/'>Pokemon Showdown</a></li>
			</ul>
		</div>
